...
void circle::print(){
   ...
   // top and bottom
   w.write(hwlib::location( mid_x + 0, mid_y + radius ));
   w.write(hwlib::location( mid_x + 0, mid_y - radius ));
      
   // left and right 
   w.write(hwlib::location( mid_x + radius, mid_y + 0 ));
   w.write(hwlib::location( mid_x + radius, mid_y - 0 ));
   ...
   while( x < y ){
      ...
      w.write(hwlib::location(mid_x + x, mid_y + y ));
      w.write(hwlib::location(mid_x - x, mid_y + y ));
      w.write(hwlib::location(mid_x + x, mid_y - y ));
      w.write(hwlib::location(mid_x - x, mid_y - y ));
      w.write(hwlib::location(mid_x + y, mid_y + x ));
      w.write(hwlib::location(mid_x - y, mid_y + x ));
      w.write(hwlib::location(mid_x + y, mid_y - x ));
      w.write(hwlib::location(mid_x - y, mid_y - x ));
   }
